...
[**XLD**](https://tmkk.undo.jp/xld/index_e.html) is a super cool open source audio converter. Unfortunately the file documentation is quite spotty around meta data so I created my own guide for XLD file naming.
