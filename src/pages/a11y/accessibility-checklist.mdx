...
- The document's language is correctly set (`<html lang="de-DE">`)
...
- Short text uses `<span>`, paragraphs of text uses `<p>`
...
- Interactive patterns (for example "Accorion", "Tab", "Carousel", "Modal", "Breadcrumb") follow the [WAI ARIA Authoring Practices Guide](https://www.w3.org/WAI/ARIA/apg/patterns/)
...
- Focusable elements (buttons, links, tabs, form inputs) must have visible focus styles
